...
if ($_POST == TRUE) {
    ...
    $creneauRecherche  = mktime(8, 0, 0, date("m")  , date("d")+1, date("Y"));   //date du lendemain à 8h00, date à laquelle nous allons commencer la recherche de créneau disponible
